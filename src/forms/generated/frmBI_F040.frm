VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F040 
   Caption         =   "BI_FDRSchedule"
   ClientHeight    =   5240
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F040.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F040"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_FDRSchedule"
Private Const PARAM_COUNT As Long = 4
Private Const PARAM_LABELS As String = "DepositAmount|InterestRate|Stdate|Enddate"
Private Const DESCRIPTION_TEXT As String = "Returns the Fixed Deposit Schedule of Interest calculations and maturiy value."
