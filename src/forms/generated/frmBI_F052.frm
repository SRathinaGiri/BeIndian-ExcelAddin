VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F052 
   Caption         =   "BI_GEL2Test"
   ClientHeight    =   2840
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   7100
   OleObjectBlob   =   "frmBI_F052.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F052"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_GEL2Test"
Private Const PARAM_COUNT As Long = 4
Private Const PARAM_LABELS As String = "AnalyzeData|RelatedData|DataItem|Total"
Private Const DESCRIPTION_TEXT As String = "Calculates Gestalt Element Link Test 2 between two columns of related data like Salesman and Customer for a particular dataitem."
