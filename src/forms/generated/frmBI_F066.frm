VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F066 
   Caption         =   "BI_MUS_ExtractSample"
   ClientHeight    =   5840
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F066.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F066"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_MUS_ExtractSample"
Private Const PARAM_COUNT As Long = 5
Private Const PARAM_LABELS As String = "Data|Tolerable|Expected|Risk|OnlySamples"
Private Const DESCRIPTION_TEXT As String = "Returns Monetary Unit Sampling Samples from Data."
