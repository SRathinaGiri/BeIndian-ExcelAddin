VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F014 
   Caption         =   "BI_BeginsWith"
   ClientHeight    =   4640
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F014.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F014"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_BeginsWith"
Private Const PARAM_COUNT As Long = 3
Private Const PARAM_LABELS As String = "FindText|WithinText|CaseSensitive"
Private Const DESCRIPTION_TEXT As String = "Returns whether one text begins with another text."
