VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F079 
   Caption         =   "BI_Rank_Dense"
   ClientHeight    =   2840
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   7100
   OleObjectBlob   =   "frmBI_F079.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F079"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_Rank_Dense"
Private Const PARAM_COUNT As Long = 3
Private Const PARAM_LABELS As String = "Number|Ref|Order"
Private Const DESCRIPTION_TEXT As String = "Returns the Rank without any missing rank when there is a tie."
