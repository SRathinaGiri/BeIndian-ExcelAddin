VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F050 
   Caption         =   "BI_Fuzzy"
   ClientHeight    =   5840
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F050.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F050"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_Fuzzy"
Private Const PARAM_COUNT As Long = 5
Private Const PARAM_LABELS As String = "a|b|ii|jj|arr"
Private Const DESCRIPTION_TEXT As String = "Returns the number of modifications required to change from first text to second text. This finds Levenshtein distance between two strings."
