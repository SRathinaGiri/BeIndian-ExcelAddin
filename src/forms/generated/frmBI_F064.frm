VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F064 
   Caption         =   "BI_MUS_Evaluate_OverStatement"
   ClientHeight    =   2840
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   7100
   OleObjectBlob   =   "frmBI_F064.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F064"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_MUS_Evaluate_OverStatement"
Private Const PARAM_COUNT As Long = 6
Private Const PARAM_LABELS As String = "Data|Sample|Audited|Tolerable|Expected|Risk"
Private Const DESCRIPTION_TEXT As String = "Returns Monetary Unit Sampling evaluation of Over Statement from the Audited and Samples data."
