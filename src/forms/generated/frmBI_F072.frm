VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F072 
   Caption         =   "BI_PaybackPeriod"
   ClientHeight    =   4640
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F072.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F072"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_PaybackPeriod"
Private Const PARAM_COUNT As Long = 1
Private Const PARAM_LABELS As String = "CashFlows"
Private Const DESCRIPTION_TEXT As String = "Returns the payback period from series of cash flows"
