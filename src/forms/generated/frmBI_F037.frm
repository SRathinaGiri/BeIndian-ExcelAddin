VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F037 
   Caption         =   "BI_ExponentialSmoothing"
   ClientHeight    =   4640
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F037.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F037"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_ExponentialSmoothing"
Private Const PARAM_COUNT As Long = 3
Private Const PARAM_LABELS As String = "Data|DampingFactor|Labels"
Private Const DESCRIPTION_TEXT As String = "Returns Exponential Smoothened data after applying Damping Factor. This is one of the Data Analysis Toolpak features."
