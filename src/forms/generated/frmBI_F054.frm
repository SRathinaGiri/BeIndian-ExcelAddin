VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F054 
   Caption         =   "BI_GenerateRandomBetween"
   ClientHeight    =   2840
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   7100
   OleObjectBlob   =   "frmBI_F054.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F054"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_GenerateRandomBetween"
Private Const PARAM_COUNT As Long = 5
Private Const PARAM_LABELS As String = "Seed|Size|Bottom|Top|Integer"
Private Const DESCRIPTION_TEXT As String = "Function to generate static random numbers between two numbers using a Random Seed. This is one of the Data Analysis Toolpak features."
