VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F073 
   Caption         =   "BI_PiotroskiFScore"
   ClientHeight    =   4640
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F073.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F073"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_PiotroskiFScore"
Private Const PARAM_COUNT As Long = 2
Private Const PARAM_LABELS As String = "LastYearData|CurrentYearData"
Private Const DESCRIPTION_TEXT As String = "Calculates Piotroski F-score. Use BI_PiotroskiFScoreVariables() to list the variables and enter two years data"
