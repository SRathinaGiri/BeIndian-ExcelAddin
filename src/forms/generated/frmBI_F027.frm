VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F027 
   Caption         =   "BI_Consolidate"
   ClientHeight    =   2840.001
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   7100
   OleObjectBlob   =   "frmBI_F027.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F027"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_Consolidate"
Private Const PARAM_COUNT As Long = 11
Private Const PARAM_LABELS As String = "Function|DataRange1|DataRange2|DataRange3|DataRange4|DataRange5|DataRange6|DataRange7|DataRange8|DataRange9|DataRange10"
Private Const DESCRIPTION_TEXT As String = "Multiple Consolidation Ranges"
...
Private Sub cmdArg5_Click()
    PickRangeInto Me.txtArg5, "Select argument 5 range"
End Sub

Private Sub cmdArg6_Click()
    PickRangeInto Me.txtArg6, "Select argument 6 range"
End Sub

Private Sub cmdArg7_Click()
    PickRangeInto Me.txtArg7, "Select argument 7 range"
End Sub

Private Sub cmdArg8_Click()
    PickRangeInto Me.txtArg8, "Select argument 8 range"
End Sub

Private Sub cmdArg9_Click()
    PickRangeInto Me.txtArg9, "Select argument 9 range"
End Sub

Private Sub cmdArg10_Click()
    PickRangeInto Me.txtArg10, "Select argument 10 range"
End Sub

Private Sub cmdArg11_Click()
    PickRangeInto Me.txtArg11, "Select argument 11 range"
End Sub
