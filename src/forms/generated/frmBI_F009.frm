VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F009 
   Caption         =   "BI_ArrayFilter"
   ClientHeight    =   2840
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   7100
   OleObjectBlob   =   "frmBI_F009.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F009"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_ArrayFilter"
Private Const PARAM_COUNT As Long = 3
Private Const PARAM_LABELS As String = "Array|CriteriaArray|SelectedColumns"
Private Const DESCRIPTION_TEXT As String = "Filters a Table for a multi-column criteria array by matching selected columns with the criteria array."
