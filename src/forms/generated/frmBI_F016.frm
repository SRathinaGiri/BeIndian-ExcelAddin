VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F016 
   Caption         =   "BI_BeneishMScoreVariables"
   ClientHeight    =   4640
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F016.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F016"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_BeneishMScoreVariables"
Private Const PARAM_COUNT As Long = 0
Private Const PARAM_LABELS As String = ""
Private Const DESCRIPTION_TEXT As String = "Lists out Beneish M Score variables to make it easy to enter two years data for calculating Beneish M Score."
