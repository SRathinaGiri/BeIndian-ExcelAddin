...
End
Attribute VB_Name = "frmBI_F086"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_RupeeSymbol"
Private Const PARAM_COUNT As Long = 0
Private Const PARAM_LABELS As String = ""
Private Const DESCRIPTION_TEXT As String = "Returns the Rupee Symbol Ã¢â€šÂ¹"
