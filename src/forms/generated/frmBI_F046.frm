VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmBI_F046 
   Caption         =   "BI_FindMissingNumbers"
   ClientHeight    =   4640
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   10180
   OleObjectBlob   =   "frmBI_F046.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmBI_F046"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const FUNCTION_NAME As String = "BI_FindMissingNumbers"
Private Const PARAM_COUNT As Long = 1
Private Const PARAM_LABELS As String = "List"
Private Const DESCRIPTION_TEXT As String = "Returns missing numbers from a list of numbers"
